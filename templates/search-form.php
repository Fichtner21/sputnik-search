<?php if( get_option('visibility_version') === 'toggle-visibility' ) : ?>
    <button aria-hidden="true" type='button' class='sputnik-search-form__toggle' id='sputnik-search-form-toggle' title='<?= __('Wyszukiwarka', 'sputnik-search'); ?>'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 0 136 136.21852" id="sputnik-search-toggle-icon" width='20'>
            <g>
